...
$("button#test-button").on("click", "button#test-button", function (e) {
  console.log("make noise?");
});
document.getElementById("test-button").on("click", function (e) {
  console.log("im not afraid to take a stand!");
});
document
